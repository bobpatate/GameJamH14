...
////// Emissive:
                ...
                float4 node_2 = tex2D(_node2,TRANSFORM_TEX(node_23.rg, _node2));
                float3 emissive = (node_2.rgb*node_2.r);
                float3 finalColor = 0;
...
/////// Diffuse:
                ...
                float4 node_2 = tex2D(_node2,TRANSFORM_TEX(node_24.rg, _node2));
                finalColor += diffuseLight * node_2.rgb;
/// Final Color:
