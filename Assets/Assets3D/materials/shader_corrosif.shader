...
////// Emissive:
                ...
                float4 node_2 = tex2D(_node2,TRANSFORM_TEX(node_17.rg, _node2));
...
/////// Diffuse:
                ...
                float4 node_2 = tex2D(_node2,TRANSFORM_TEX(node_18.rg, _node2));
                finalColor += diffuseLight * node_2.rgb;
/// Final Color:
