...
public class GUI_test : MonoBehaviour {
	...
	void OnGUI () {
		...
		////
		/// 
		GUI.Box (new Rect (Screen.width*20/1617 ,Screen.height - Screen.height*130/910,Screen.width*110/1617,Screen.height*110/910), iconWepT1);
